...
public class ArrayListCombiner {
    ...
    public static <E> void  extendCombiner(ArrayList<? extends E> list1, ArrayList list2) {

        list1.addAll(list2);
    }

    public static <E> void  superCombiner(ArrayList<? super E> list1, ArrayList list2) {
        list1.addAll(list2);
    }
}
